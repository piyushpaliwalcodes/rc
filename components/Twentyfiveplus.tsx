    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row w-full justify-between p-4 py-6 md:p-[60px] text-black gap-6 md:gap-0">
            ...
            <div className="w-full md:w-[633px] flex flex-col gap-6 md:gap-[30px] mx-auto">
                <Highlight/>
                <div className="flex flex-row gap-4 md:gap-[30px] justify-between w-full">
                    <div className="flex flex-col gap-2 md:gap-[10px] w-full md:w-auto">
                        {bulletpoints.map((bulletpoint,index)=>(
                            <div key={index} className="flex gap-2 md:gap-[8px] items-center">
                                ...
                                <p className="text-[12px] md:text-base">{bulletpoint.title}</p>
                            </div>
                        ))}
                        <YellowButton className="mt-4 md:mt-[30px] w-full" text='Contact Us' link='/contactus'/>
                    </div>
                    <div className="bg-[#F5F5F5] w-[80%] h-[80px] md:h-auto md:w-[300px] rounded-[10px]  md:mt-0 "> 
                        <Image src="/images/rating.png" alt="25plus" width={1000} height={1000} className="w-full md:h-auto object-cover rounded-[10px]"/>
                    </div>
                </div>
            </div>
        </div>
