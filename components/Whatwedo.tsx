...
{
    return (
        <div className="flex flex-col gap-6 md:gap-[30px] py-6 md:py-[60px] justify-center w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-between mt-6 md:mt-[40px] gap-4 md:gap-0 w-full">
                {
                    images.map((image, idx) => (
                        <div className="flex flex-col gap-2 items-center w-full sm:w-auto" key={idx}>
