        ...
        <div className='w-full px-[60px] flex gap-[150px] py-[60px] text-black' >
            <div className="flex flex-col max-w-[710px] justify-between h-[400px]">
               ...
               <p className="text-[16px]">
                ...
                <div className="flex gap-[30px]"><YellowButton text="Read More" link="/aboutus" /> <div className="h-full justify-center items-center"><a href="/" className="text-[16px] flex items-center  underline h-full ">Quality Certificate</a></div>
                </div>
            </div>
