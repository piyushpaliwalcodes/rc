        ...
        <div className='w-full max-w-full flex flex-col lg:flex-col gap-8 lg:gap-[40px] py-6 px-4 md:px-8 lg:px-[60px]  md:py-[100px] text-black bg-[#FFF9D487]'>
                ...
                <div className="flex flex-col gap-4 md:gap-[20px]"> 
                    <div className="flex flex-col gap-2 md:gap-[30px]">
                       ...
                       <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <p className="text-[24px] md:text-[32px] lg:text-[40px]/[50px] w-full md:w-2/3 lg:w-1/2 "> <span className="font-bold">RC Dal – </span>  India’s Trusted Brand <br/> for Pure and Premium Dals</p> <YellowButton text="About our Journey" link="/aboutus" className="max-h-[40px] self-start md:self-auto"/></div> 
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full max-w-full">
                {features.map((feature, index) => (
                    <div key={index} className="flex gap-3 md:gap-[15px] items-start sm:items-center">
