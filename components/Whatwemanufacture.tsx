...
const Manufacturecardwithimage = ({
    ...
    var src=img;
    return (
        <div className="flex flex-col w-full md:w-[342px]   border border-black/10 rounded-lg shadow-sm h-full bg-[#F9F9F9]">
...
const Whatwemanufacture = () => {   
 ...
 <div className="flex flex-col ">
        <p className=" uppercase tracking-widest text-black/40 text-[14px] md:text-[18px] font-bold">WHAT WE MANUFACTURE</p>
        <div className="flex w-full justify-between items-center"><p className="text-[40px]">Pure and Trusted Dal Products from <span className="font-bold">RC Pulses.</span></p>
