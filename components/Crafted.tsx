...
const Crafted = () =>
{
    return <div className="flex flex-col gap-6 md:gap-[50px] px-4 md:px-[60px] py-6 md:py-[60px]  text-black items-center bg-[#FFFCE8]">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-30  w-full">
            ...
            <img src="/images/bori.png" alt="Traditional storage bag of grains" className="w-full  max-w-[400px] h-auto object-contain"/>
        </div>
    </div>
