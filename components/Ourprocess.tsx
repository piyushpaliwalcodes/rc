...
const Ourprocess = () => {  
    ...
    return (
        <div className="flex  gap-[150px]  justify-center px-[60px] py-[60px] bg-[#F5F5F5]">
            <div className="flex flex-col gap-[30px] ">
                ...
                ">Our Processes</p></div>
                <p className="text-[48px]/[60px]">Streamlined processes <span className="font-bold">for optimal efficiency</span></p>
                <Image src="/images/machinewithmala.png" alt="process" width={1000} height={1000} className="w-full" />
            </div>
            <div className="flex flex-col justify-around text-[#81848A] font-manrope text-[16px]">
                  <p className="pl-[100px]">Our process is designed to maximize efficiency and quality at every stage
of production. By integrating advanced technologies and best practices,
we ensure seamless workflows.</p>
                   <div className="flex flex-col gap-[20px]">
                    {
                        steps.map((step,index) => (
                            <div key={index} className={`flex gap-[20px] py-[25px] px-[25px] hover:cursor-pointer rounded-[8px] ${selectedStep === index ? "bg-[#FCD900] text-black" : ""}`} onClick={() => setSelectedStep(index)}>
