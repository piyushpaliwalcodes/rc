        ...
        <div className="flex flex-col justify-center px-4 py-6 md:px-[60px] md:py-[60px] bg-[#F5F5F5] gap-8 md:gap-[50px] text-black w-full max-w-full">
            <div className="flex flex-col gap-4 md:gap-[20px]">
                ...
                <div className="flex flex-col lg:flex-row gap-4 md:gap-[100px] items-start lg:items-end">
                    <p className="text-[24px] md:text-[48px]/[60px] font-light">Streamlined processes <span className="font-bold">for optimal efficiency</span></p>
            ...
            <div className="flex flex-col lg:flex-row gap-8 md:gap-[150px] w-full items-center">
                <div className="w-full max-w-[400px] md:max-w-[600px] lg:w-[600px] flex-shrink-0 mx-auto lg:mx-0">
                    <Image src="/images/machinewithmala.png" alt="process" width={800} height={1000} className="w-full h-auto" />
                </div>
                <div className="flex flex-col gap-4 md:gap-[20px] w-full">
                    {
                        steps.map((step,index) => (
                            <div key={index} className={`flex gap-4 md:gap-[20px] py-4 md:py-[25px] px-4 md:px-[25px] hover:cursor-pointer rounded-[8px]  ${selectedStep === index ? "bg-[#FCD900] text-black" : "hover:bg-[#ffe30029] transition-all duration-200 "}`} onClick={() => setSelectedStep(index)}>
