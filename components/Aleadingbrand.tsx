...
const Aleadingbrand = () =>
{
    return <div className="flex flex-col w-full h-[766px] py-[100px] px-[60px] gap-[30px] items-center bg-[#FBF9F4]">
      <div className="text-[64px]/[80px] text-center">A <span className="font-semibold yellounderline">Leading Brand</span> in India's <br/>Dal Manufacturer's</div>
...
<div className="grid overflow-x-auto md:overflow-x-visible grid-cols-5 pt-8  gap-4 md:gap-0">
